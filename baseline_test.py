...
def main(config):
    ...
    graph_pkl_filename = 'data/manhattan_withInOut_splitlength.pkl'
    adj_mat = utils.load_graph_data(graph_pkl_filename)
    data, means, stds = utils.load_dataset(data_path='data/manhattan_withInOut_splitlength.pkl',
...
if __name__ == '__main__':
    ...
    args.add_argument('-r', '--resume', default='/root/pytorch-DCRNN/saved/manhattan/models/Manhattan_DCRNN/1026_205224/model_best.pth', type=str,
